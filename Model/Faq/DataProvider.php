 ...
 */
namespace MageCloud\Faq\Model\Faq;

use MageCloud\Faq\Model\ResourceModel\Faq\CollectionFactory;
...
{
    /**
     * @var \MageCloud\Faq\Model\ResourceModel\Faq\Collection
     */
    ...
    public function getData()
    {
        ...
        $data = $this->dataPersistor->get('magecloud_faq');
        if (!empty($data)) {
